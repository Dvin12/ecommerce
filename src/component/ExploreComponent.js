      ...
      <div className="mx-auto px-6  py-20 xl:mx-40 ">
        <article className="mb-20 flex flex-col xl:grid xl:grid-cols-2  ">
          ...
          <div className="flex  flex-col items-center gap-2 py-4 ">
            ...
            <h2 className=" py-4 text-center text-3xl font-semibold tracking-wide text-gray-800 xl:w-3/5 xl:text-5xl xl:leading-[54px] ">
              Awesome In Any Space. Perfectly Blend In Your Life.
            </h2>
            <p className=" text-justify text-lg leading-relaxed tracking-wider text-gray-600  xl:w-2/3 ">
        ...
        <article className="mx-auto flex  flex-col   xl:mx-28 xl:grid xl:grid-cols-2 ">
          <div className=" order-1 my-8 flex    flex-col items-center justify-center gap-4">
            <tag className=" rounded bg-indigo-300 px-4 py-2 text-sm drop-shadow-md">
              We Offer
            </tag>
            <h2 className=" py-3 text-center text-3xl font-semibold tracking-wide text-gray-800 xl:leading-[54px] ">
