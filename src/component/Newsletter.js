function Newsletter() {
  return (
    <div className=" flex  flex-col items-center justify-center gap-6 rounded-2xl bg-gradient-to-r from-sky-300 to-blue-500 px-2 py-20 drop-shadow-lg md:py-8  xl:py-24">
