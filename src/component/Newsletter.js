function Newsletter() {
  return (
    <div className=" flex w-full flex-col items-center justify-center gap-6 rounded-2xl bg-gradient-to-r from-sky-300 to-blue-500 px-2 py-20 drop-shadow-lg">
      ...
      <div className=" relative flex flex-col items-center justify-center gap-4">
        <input
          ...
          className="w-[300px] rounded-lg p-4 xl:w-[700px] xl:p-6"
        ></input>
